...
//check if session variable is set and false, then redirect
if (isset($_SESSION['login']) == false) {
     header('Location: login.php');
}

//if it's true then get posts
else {
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
                <div class="form-group">
                    <input class="form-control" placeholder="First Name" value= <?php echo "'" . $_SESSION['firstName']. "'"; ?> 
                    name="firstName">
                </div>
                <div class="form-group">
                    <input class="form-control" placeholder="Last Name" value= <?php echo "'" . $_SESSION['lastName']. "'"; ?>  name="lastName">
                </div>
                <div class="form-group">
                    <label>Title</label>
